...
(function () {
  ...
  /* Match OnDesk: absolute iframe + height; full vertical span (top→bottom) on the right. */
  iframe.style.display = 'none';
  ...
  iframe.style.boxShadow = '-4px 0 24px rgba(0,0,0,0.18)';
  ...
  toggler.style.boxShadow = '0 2px 8px rgba(0, 0, 0, 0.15)';
